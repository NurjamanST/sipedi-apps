<x-layout>
    <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-5 gap-4 mb-4">
            ...
            <div class=" max-w-full p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                <a href="#">
                    <h5 class="mb-2 text-2xl font-semibold tracking-tight text-gray-900 dark:text-white">Pengurus</h5>
                </a>
                <a href="#" class="inline-flex font-medium items-center text-blue-600 hover:underline">
                    Lihat Data
                    <svg class="w-3 h-3 ms-2.5 rtl:rotate-[270deg]" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 18 18">
            ...
            <div class=" max-w-full p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                <a href="#">
                    <h5 class="mb-2 text-2xl font-semibold tracking-tight text-gray-900 dark:text-white">Pelatih Cabang</h5>
                </a>
                <a href="#" class="inline-flex font-medium items-center text-blue-600 hover:underline">
                    Lihat Data
                    <svg class="w-3 h-3 ms-2.5 rtl:rotate-[270deg]" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 18 18">
            ...
            <div class=" max-w-full p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                <a href="#">
                    <h5 class="mb-2 text-2xl font-semibold tracking-tight text-gray-900 dark:text-white">Pelatih Ranting</h5>
                </a>
                <a href="#" class="inline-flex font-medium items-center text-blue-600 hover:underline">
                    Lihat Data
                    <svg class="w-3 h-3 ms-2.5 rtl:rotate-[270deg]" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 18 18">
            ...
            <div class=" max-w-full p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                <a href="#">
                    <h5 class="mb-2 text-2xl font-semibold tracking-tight text-gray-900 dark:text-white">Ranting/Unit</h5>
                </a>
                <a href="#" class="inline-flex font-medium items-center text-blue-600 hover:underline">
                    Lihat Data
                    <svg class="w-3 h-3 ms-2.5 rtl:rotate-[270deg]" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 18 18">
            ...
            <div class=" max-w-full p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                <a href="#">
                    <h5 class="mb-2 text-2xl font-semibold tracking-tight text-gray-900 dark:text-white">Anggota</h5>
                </a>
                <a href="#" class="inline-flex font-medium items-center text-blue-600 hover:underline">
                    Lihat Data
                    <svg class="w-3 h-3 ms-2.5 rtl:rotate-[270deg]" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 18 18">
        ...
        {{-- Grafik Sebaran Anggota Berdasarkan tingkatan --}}
        <div class="w-full bg-white rounded-lg shadow p-4 md:p-6 my-5">
            <div class="flex justify-between pb-4 mb-4 border-b border-gray-200 dark:border-gray-700">
                <div class="flex items-center">
                    <div class="w-12 h-12 rounded-lg bg-gray-100 dark:bg-gray-700 flex items-center justify-center me-3">
                    ...
                    <div>
                        <h5 class="leading-none text-2xl font-bold text-gray-900 dark:text-white pb-1">Keanggotaan</h5>
                        <p class="text-sm font-normal text-gray-500 dark:text-gray-400">Sebaran anggota berdasarkan tingkatan</p>
                    </div>
                </div>
                <div>
        ...
        {{-- Sipedi Niaga | 2 Kolom --}}
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 mb-4">
            {{-- Produk --}}
            <div class=" max-w-full p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                <a href="#">
                    <h5 class="mb-2 text-2xl font-semibold tracking-tight text-gray-900 dark:text-white">Produk</h5>
                </a>
                {{-- <p class="mb-3 font-normal text-xl text-gray-500 dark:text-gray-400">1</p> --}}
                <a href="#" class="inline-flex font-medium items-center text-blue-600 hover:underline">
                    Lihat Data
                    <svg class="w-3 h-3 ms-2.5 rtl:rotate-[270deg]" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 18 18">
                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11v4.833A1.166 1.166 0 0 1 13.833 17H2.167A1.167 1.167 0 0 1 1 15.833V4.167A1.166 1.166 0 0 1 2.167 3h4.618m4.447-2H17v5.768M9.111 8.889l7.778-7.778"/>
            ...
            <div class=" max-w-full p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                <a href="#">
                    <h5 class="mb-2 text-2xl font-semibold tracking-tight text-gray-900 dark:text-white">Pesanan</h5>
                </a>
                {{-- <p class="mb-3 font-normal text-xl text-gray-500 dark:text-gray-400">1</p> --}}
                <a href="#" class="inline-flex font-medium items-center text-blue-600 hover:underline">
                    Lihat Data
        ...
        <div class="w-full bg-white rounded-lg shadow p-4 md:p-6 my-5">
            <div class="flex justify-between pb-4 mb-4 border-b border-gray-200 dark:border-gray-700">
                <div class="flex items-center">
                    ...
                    <div>
                        <h5 class="leading-none text-2xl font-bold text-gray-900 dark:text-white pb-1">Kedanusan</h5>
                        <p class="text-sm font-normal text-gray-500 dark:text-gray-400">Sebaran anggota berdasarkan tingkatan</p>
                    </div>
                </div>
                <div>
