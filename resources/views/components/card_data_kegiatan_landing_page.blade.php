<div class="grid lg:grid-rows-1 grid-rows-1 bg-white border border-gray-300 rounded-lg shadow mt-1">
    ...
    <div class="grid lg:grid-cols-4 grid-cols-1 gap-4">
        ...
        @endfor
        <a href="/read_card_data_kegiatan" class="flex w-fit m-5 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
